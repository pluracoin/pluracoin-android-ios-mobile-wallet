...
import {
    ...
    ScrollView, Clipboard, Image, Animated,
} from 'react-native';
...
import {SpinnerWaiting} from "./SpinnerWaiting";
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        Should arrive in less than {getArrivalTime()}
                    </Text>
                ...
                <View style={{
                    ...
                    <Input
                        ...
                        inputContainerStyle={{
                            ...
                            borderWidth: 1,
                            borderRadius: 2,
                            backgroundColor: this.props.screenProps.theme.whiteColour
                        }}
    ...
    render() {
        return(
            <View style={{
                ...
                <Image
                    style={Styles.background}
                    source={require('../assets/img/bg-create.png')}
                />
