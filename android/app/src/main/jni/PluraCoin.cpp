...
extern "C" jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    KEY_OUTPUT = (jclass) env->NewGlobalRef(env->FindClass("com/plura/KeyOutput"));
    ...
    RAW_TRANSACTION = (jclass) env->NewGlobalRef(env->FindClass("com/plura/RawTransaction"));
    RAW_TRANSACTION_CONST = env->GetMethodID(RAW_TRANSACTION, "<init>", "([Lcom/plura/KeyOutput;Ljava/lang/String;Ljava/lang/String;)V");
    RAW_TRANSACTION_KEY_OUTPUTS = env->GetFieldID(RAW_TRANSACTION, "keyOutputs", "[Lcom/plura/KeyOutput;");
    ...
    WALLET_BLOCK_INFO = (jclass) env->NewGlobalRef(env->FindClass("com/plura/WalletBlockInfo"));
    WALLET_BLOCK_INFO_CONST = env->GetMethodID(WALLET_BLOCK_INFO, "<init>", "(Lcom/plura/RawTransaction;[Lcom/plura/RawTransaction;)V");
    WALLET_BLOCK_INFO_COINBASE_TRANSACTION = env->GetFieldID(WALLET_BLOCK_INFO, "coinbaseTransaction", "Lcom/plura/RawTransaction;");
    WALLET_BLOCK_INFO_TRANSACTIONS = env->GetFieldID(WALLET_BLOCK_INFO, "transactions", "[Lcom/plura/RawTransaction;");

    TRANSACTION_INPUT = (jclass) env->NewGlobalRef(env->FindClass("com/plura/TransactionInput"));
    ...
    SPEND_KEY = (jclass) env->NewGlobalRef(env->FindClass("com/plura/SpendKey"));
    ...
    INPUT_MAP = (jclass) env->NewGlobalRef(env->FindClass("com/plura/InputMap"));
    INPUT_MAP_CONST = env->GetMethodID(INPUT_MAP, "<init>", "(Ljava/lang/String;Lcom/plura/TransactionInput;)V");
    INPUT_MAP_PUBLIC_SPEND_KEY = env->GetFieldID(INPUT_MAP, "publicSpendKey", "Ljava/lang/String;");
    INPUT_MAP_TRANSACTION_INPUT = env->GetFieldID(INPUT_MAP, "input", "Lcom/plura/TransactionInput;");
...
Java_com_plura_PluraCoinModule_processBlockOutputsJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_plura_PluraCoinModule_generateRingSignaturesJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_com_plura_PluraCoinModule_checkRingSignatureJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_com_plura_PluraCoinModule_generateKeyDerivationJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_plura_PluraCoinModule_generateKeyImageJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_plura_PluraCoinModule_deriveSecretKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_plura_PluraCoinModule_derivePublicKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
    ...
    std::vector<std::tuple<Crypto::PublicKey, TransactionInput>> &inputs)
{
    ...
    for (const auto &output : tx.keyOutputs)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, LOG_TAG, "output.amount: %d", output.amount);
        ...
        if (ourPrivateSpendKey != spendKeys.end())
        {
            ...
            __android_log_print(ANDROID_LOG_INFO, LOG_TAG, " *** is our output.amount: %d", output.amount);
