...
public class PluraCoinModule extends ReactContextBaseJavaModule {
    static {
        System.loadLibrary("PluraCoin_jni");
    }

    public PluraCoinModule(ReactApplicationContext reactContext) {
        super(reactContext); //required by React Native
    }

    /* Access this by doing NativeModules.PluraCoin in react */
    @Override
    ...
    private void getWalletSyncDataImpl(
        ...
        try
        {
            ...
            connection.setRequestProperty("User-Agent", "plura-v.1.0");
            ...
            //Log.d("ReactNative", "TCM.java Making request to /sync with params " + params);
